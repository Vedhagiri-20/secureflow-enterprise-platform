const API_URL = "http://localhost:8080/api/eligibility/check";
...
document
    ...
    .addEventListener("submit", checkEligibility);
...
function showResult(data) {
    ...
    document.getElementById("capacity").textContent =
        formatAmount(data.suggestedCapacity);

    document.getElementById("interestRange").textContent =
        data.interestRange;
